package com.mxdl.faq.art.adapter;
...
/**
 * Description: <MyExpandableListViewAdapter><br>
 * Author:      mxdl<br>
 * Date:        2019/10/7<br>
 * Version:     V1.0.0<br>
 * Update:     <br>
...
public class MyExpandableListViewAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.child, null);
