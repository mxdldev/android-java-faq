...
public class FollowText1 extends TextView {
    ...
    public FollowText1(Context context) {
        this(context, null);
    }

    public FollowText1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public FollowText1(Context context, AttributeSet attrs, int defStyle) {
